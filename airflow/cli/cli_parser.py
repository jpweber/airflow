...
ARG_MIGRATION_TIMEOUT = Arg(
    ("-t", "--migration-wait-timeout"), help="timeout to wait for db to migrate ", type=int, default=0,
)
...
# connections
ARG_CONN_ID = Arg(('conn_id',), help='Connection id, required to add/delete a connection', type=str)
...
airflow_commands: List[CLICommand] = [
    GroupCommand(name='dags', help='List and manage DAGs', subcommands=DAGS_COMMANDS,),
    GroupCommand(name='tasks', help='List and manage tasks', subcommands=TASKS_COMMANDS,),
    GroupCommand(name='pools', help="CRUD operations on pools", subcommands=POOLS_COMMANDS,),
    GroupCommand(name='variables', help="CRUD operations on variables", subcommands=VARIABLES_COMMANDS,),
    GroupCommand(name='db', help="Database operations", subcommands=DB_COMMANDS,),
    ActionCommand(
        name='kerberos',
    ...
    GroupCommand(name='connections', help="List/Add/Delete connections", subcommands=CONNECTIONS_COMMANDS,),
    GroupCommand(name='users', help="CRUD operations on users", subcommands=USERS_COMMANDS,),
    GroupCommand(name='roles', help='Create/List roles', subcommands=ROLES_COMMANDS,),
    ActionCommand(
        name='sync_perm',
...
def _add_command(
    ...
    sub_proc = subparsers.add_parser(sub.name, help=sub.help, description=sub.description or sub.help,)
