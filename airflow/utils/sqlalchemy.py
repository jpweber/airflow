...
def skip_locked(session: Session, of: Any = None) -> Dict[str, Any]:
    """
    Return args for passing to `with_for_update()` suitable for the current DB engine version.
