...
dag1_task1 = DummyOperator(
    task_id='test_backfill_pooled_task', dag=dag1, pool='test_backfill_pooled_task_pool',
)
...
dag3_task2 = DummyOperator(task_id='test_dagrun_succeed', dag=dag3,)
...
dag5_task1 = DummyOperator(task_id='test_dagrun_succeed', dag=dag5,)
...
dag6_task1 = DummyOperator(task_id='test_depends_on_past', depends_on_past=True, dag=dag6,)
dag6_task2 = DummyOperator(task_id='test_depends_on_past_2', depends_on_past=True, dag=dag6,)
...
dag9_task1 = DummyOperator(task_id='current', dag=dag9,)
dag8_task2 = DummyOperator(task_id='future', dag=dag9, start_date=DEFAULT_DATE + timedelta(days=1),)
