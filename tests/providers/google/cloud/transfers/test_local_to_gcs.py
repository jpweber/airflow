...
class TestFileToGcsOperator(unittest.TestCase):
    ...
    def test_init(self):
        operator = LocalFilesystemToGCSOperator(task_id='file_to_gcs_operator', dag=self.dag, **self._config)
    ...
    def test_execute(self, mock_hook):
        ...
        operator = LocalFilesystemToGCSOperator(task_id='gcs_to_file_sensor', dag=self.dag, **self._config)
