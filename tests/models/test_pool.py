...
class TestPool(unittest.TestCase):
    ...
    def test_open_slots(self):
        ...
        dag = DAG(dag_id='test_open_slots', start_date=DEFAULT_DATE,)
        ...
        self.assertEqual(
            {
                "default_pool": {"open": 128, "queued": 0, "total": 128, "running": 0,},
                "test_pool": {"open": 3, "queued": 1, "running": 1, "total": 5,},
            },
            pool.slots_stats(),
        )
    ...
    def test_infinite_slots(self):
        ...
        dag = DAG(dag_id='test_infinite_slots', start_date=DEFAULT_DATE,)
        op1 = DummyOperator(task_id='dummy1', dag=dag, pool='test_pool')
        op2 = DummyOperator(task_id='dummy2', dag=dag, pool='test_pool')
        ti1 = TI(task=op1, execution_date=DEFAULT_DATE)
        ti2 = TI(task=op2, execution_date=DEFAULT_DATE)
    ...
    def test_default_pool_open_slots(self):
        ...
        dag = DAG(dag_id='test_default_pool_open_slots', start_date=DEFAULT_DATE,)
