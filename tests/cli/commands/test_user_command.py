...
class TestCliUsers(unittest.TestCase):
    ...
    def test_cli_add_user_role(self):
        ...
        args = self.parser.parse_args(['users', 'add_role', '--username', 'test4', '--role', 'Op'])
    ...
    def test_cli_remove_user_role(self):
        ...
        args = self.parser.parse_args(['users', 'remove_role', '--username', 'test4', '--role', 'Viewer'])
